...
import { Component, OnInit, OnChanges, Input, ElementRef, ViewChild, Renderer2, ViewChildren, QueryList } from '@angular/core';
...
export class DetalleComponent implements OnInit {
  @ViewChildren("exampleModal")padre:ElementRef;
  ...
  cerrarModal(){
    ...
    if (this.padre != null) {
      ...
      let papa =document.getElementsByTagName('body');
      let hijoo = document.getElementsByClassName("modal-backdrop");
      console.log(papa);
      console.log(hijoo)
      papa[0].parentNode.removeChild(hijoo[0]);
      papa[0].parentNode.removeChild(hijoo[1]);
